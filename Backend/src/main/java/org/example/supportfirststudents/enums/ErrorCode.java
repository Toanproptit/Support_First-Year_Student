...
public enum ErrorCode {
    ...
    ACTIVITY_NOT_FOUND(1037, "Activity not found", HttpStatus.NOT_FOUND),
    ACTIVITY_CAPACITY_FULL(1057, "Activity capacity is full", HttpStatus.BAD_REQUEST),
    PARTICIPATION_NOT_FOUND(1038, "Participation not found", HttpStatus.NOT_FOUND),
    PARTICIPATION_ALREADY_EXISTS(1039, "Participation already exists", HttpStatus.BAD_REQUEST),
    PARTICIPATION_CANCEL_REQUESTED(1058, "Cancellation request already submitted", HttpStatus.BAD_REQUEST),
    PARTICIPATION_CANCEL_NOT_REQUESTED(1059, "Cancellation request not found", HttpStatus.BAD_REQUEST),
    ...
    MAJOR_CODE_REQUIRED(400, "Major code is required", HttpStatus.BAD_REQUEST),
