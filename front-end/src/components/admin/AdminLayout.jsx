...
const menuItems = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path d="M20 13V7a2 2 0 0 0-2-2h-6l-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h10" />
        <path d="M16 19h6" />
        <path d="M19 16v6" />
      </svg>
    ),
...
export default function AdminLayout() {
  ...
  const handleLogout = () => {
    clearAuth();
    toast.show({ type: "info", title: "Đã đăng xuất", message: "Bạn đã đăng xuất khỏi tài khoản Admin." });
